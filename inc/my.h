...
** Last update Tue Apr 12 20:45:22 2016 Mehdi Meridja
*/
...
int     commancement(char *chaine, char *chaines);
void    unset(t_shell *sh, int i, int j, int nb);
void    creation_env_fin(char **new, int i, t_shell *sh);
void    creation_env(t_shell *sh);
